...
%     minx = mean(CCRAW(it).xyRAW(:,1))-1*std(CCRAW(it).xyRAW(:,1));
%     miny = mean(CCRAW(it).xyRAW(:,2))-1*std(CCRAW(it).xyRAW(:,2));
%     maxx = mean(CCRAW(it).xyRAW(:,1))+1*std(CCRAW(it).xyRAW(:,1));
%     maxy = mean(CCRAW(it).xyRAW(:,2))+1*std(CCRAW(it).xyRAW(:,2));
